...
from loader_multihot import graph_data_obj_to_nx_simple, nx_to_graph_data_obj_simple
...
class MaskAtom:
    ...
    def __call__(self, data, masked_atom_indices=None):
        ...
        * mask rate number of atom indices
        ...
        for atom_idx in masked_atom_indices:
            # data.x[atom_idx] = torch.cat((masked_atom_feature, masked_fg_feature), 0)
            data.x[atom_idx] = torch.zeros(118+130).to(torch.long)
